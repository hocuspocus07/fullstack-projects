...
export function LoginComponent() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-custom-bg bg-cover bg-center">
      <div className="w-full max-w-md p-6 bg-white bg-opacity-10 backdrop-blur-lg rounded-lg shadow-lg">
        <h2 className="text-2xl font-bold text-center text-transparent text-white">
          LOGIN
        </h2>
        {error && (
        ...
        <form onSubmit={handleLogin} className="mt-6 space-y-4">
          <input
            ...
            required
            className="w-full px-4 py-2 text-sm border bg-white bg-opacity-10 backdrop-blur-lg rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
          />
