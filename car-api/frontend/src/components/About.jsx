...
function About() {
  return (
    <div className="h-screen w-screen text-white flex flex-col">
      ...
      <div className="flex flex-col lg:flex-row justify-end w-full float-right sm:px-16 space-y-6 lg:space-y-0">
        <div className="lg:w-1/3 py-6 rounded-lg border-1 border-white px-2 shadow-lg">
